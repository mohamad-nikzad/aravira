...
- [BL-0004 Login and register with OTP](ready/BL-0004-login-and-register-with-otp.md)
- [BL-0005 Forgot password flow](ready/BL-0005-forgot-password-flow.md)
...
- [BL-0015 Admin panel](inbox/BL-0015-admin-panel.md)
...
- [BL-0027 Fix onboarding notifications step — env-gated providers and Bale beside Telegram](done/BL-0027-bale-integration-in-onboarding.md)
...
- [BL-0026 Enforce Latin-only characters in password fields](done/BL-0026-password-latin-characters-only.md)
