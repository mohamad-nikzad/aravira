...
declare function Drawer({ repositionInputs, ...props }: React.ComponentProps<typeof DrawerPrimitive.Root>): import("react/jsx-runtime").JSX.Element;
...
declare function DrawerNested({ repositionInputs, ...props }: React.ComponentProps<typeof DrawerPrimitive.NestedRoot>): import("react/jsx-runtime").JSX.Element;
